...
$CFG->dbhost    = getenv('MOODLE_DB_HOST_NAME');  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('MOODLE_DB_NAME');     // database name, eg moodle
$CFG->dbuser    = getenv('MOODLE_DB_USER_NAME');   // your database username
...
//$CFG->sslproxy = getenv('MOODLE_SSL_PROXY') ?: false;
//
